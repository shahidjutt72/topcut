...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
      ...
      _renderEvent: function (calEvent, $weekDay) {
         ...
         eventClass = calEvent.id ? ((calEvent.color_class ? calEvent.color_class : "dummyclass")+" "+"wc-cal-event") : ("wc-cal-event wc-new-cal-event");
         eventHtml = "<div class=\"" + eventClass + " ui-corner-all\">\
                <div class=\""+(calEvent.color_class ? calEvent.color_class : "dummyclass")+" "+"wc-time ui-corner-all\"></div>\
